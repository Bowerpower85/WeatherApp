...
showWeather = (city) => {
    ...
    $.ajax(
        ...
        const icon = 'https://api.openweathermap.org/img/w/' + response.weather[0].icon + '.png';
        ...
        $.ajax({
            ...
            const icon1 = 'http://openweathermap.org/img/w/' + response.list[1].weather[0].icon + '.png';
            const icon2 = 'http://openweathermap.org/img/w/' + response.list[9].weather[0].icon + '.png';
            const icon3 = 'http://openweathermap.org/img/w/' + response.list[17].weather[0].icon + '.png';
            const icon4 = 'http://openweathermap.org/img/w/' + response.list[25].weather[0].icon + '.png';
            const icon5 = 'http://openweathermap.org/img/w/' + response.list[33].weather[0].icon + '.png';

            const date1 = response.list[1].dt_txt;
            const date2 = response.list[9].dt_txt;
            const date3 = response.list[17].dt_txt;
            const date4 = response.list[25].dt_txt;
            const date5 = response.list[33].dt_txt;
